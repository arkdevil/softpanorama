...
;	благодаpен за кpитику.
 ...
 .MODEL TINY
 .DATA
Help  db 'TSR for Text Screen Copy. (C) Milukow 1995',10,13
      db 'Use  RESEDA r  to stay Resident',10,13
      db 'Use  RESEDA rf to stay Resident and get screen fonts',10,13
