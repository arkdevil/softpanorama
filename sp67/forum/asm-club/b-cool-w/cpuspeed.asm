; -----------------------------------------------------------------------------
; CPUSPEED.ASM  CPU speed measurement routine			Version 1.14c
;
; Too-Much-In-One-So-Don't-Get-Lost(tm) CPU/FPU feature detection library
;
; Copyright(c) 1993,94 by B-coolWare.  Written by Bobby Z.
; -----------------------------------------------------------------------------
; History:
;
...
;	01/09/94	Windoze begin/end critical functions added.
...
; CPUid is value from 0 to 0Fh identifying processor we're running on
; 8088   = 00h
; 8086   = 01h
; V20    = 02h
; V30    = 03h
