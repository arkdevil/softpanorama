     ...
     int depth;
{
  ...
  if (! ((name0 != NULL && name1 != NULL)
	 || (unidirectional_new_file_flag && name1 != NULL)
  ...
  inf[0].desc = name0 == NULL ? -1 : -2;
  inf[1].desc = name1 == NULL ? -1 : -2;
...
#ifdef __MSDOS__
  inf[0].name = dir0 == NULL ? name0 : concat (dir0,
    dir0[(i = strlen(dir0) - 1)] == '/' || dir0[i] == '\\' ? "" : "/",
    name0);
  inf[1].name = dir1 == NULL ? name1 : concat (dir1,
    dir1[(i = strlen(dir1) - 1)] == '/' || dir1[i] == '\\' ? "" : "/",
    name1);
#else __MSDOS__
