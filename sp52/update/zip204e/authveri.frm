...
In order to receive a serial number to use with the PUTAV program, please 
fill out and return this form to PKWARE.  When the enclosed information is 
...
distribute the executable programs PKZIP, PKUNZIP or self-extracting PKSFX 
files for commercial purposes.  See LICENSE.DOC or contact PKWARE Inc. for 
more information about distribution licenses for the software.

Please Read the entire chapter on AV before filling this out.

 1) My full registration for PKZIP/PKUNZIP/PKSFX   ($47+S&H) is enclosed
    (circle one)  YES  NO
...
City:___________________  State:______   Zip Code: ___________________
...
that you provide only your company's name or individual's name for the
AV string.

The "AVEXTRA.TXT" feature was designed to additionally display telephone
numbers, addresses, BBS numbers, BBS nodes or parameter, CompuServe
addresses and similar information.

***NOTE: that the actual AV text will be displayed on ONE line.
