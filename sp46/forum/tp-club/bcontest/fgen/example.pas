...
type
 ...
 constructor XForm.Init;
  ...
  begin
   ...
   R.Assign(1, 13, 58, 14);
   Insert(New(PStaticText, Init(R, '          │                longint date ───┴─ last field');
   R.Assign(12, 2, 15, 3);
   B:=New(PLChar, Init(R));
   Insert(B);
   R.Assign(2, 2, 12, 3);
   ...
   B:=New(PLDate, Init(R));
   Insert(B);
   R.Assign(35, 11, 41, 12);
   Insert(New(PLabel, Init(R, 'Date', B)));
   R.Assign(41, 15, 55, 17);
   Insert(New(PButton, Init(R, '~B~utton', 113, 0)));
   SelectNext(False);
  end;
