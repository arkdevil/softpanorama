...
const CopR = 'Cyrillic Windows Font loader.  (C) V.S. Rabets, 1994';
...
procedure Help;
begin writeln (
   #9'Нерезидентный загрузчик экранной кириллицы в кодировке Windows.'#13#10 +
...
procedure FontWin_16; external;  {$L Win_16.obj}
procedure FontWin_14; external;  {$L Win_14.obj}
procedure FontWin_08; external;  {$L Win_08.obj}
...
begin
  ...
  with R do begin
       ...
       ES:=CSeg;
       case BH of
           16: BP:=Ofs(FontWin_16);
           14: BP:=Ofs(FontWin_14);
            8: BP:=Ofs(FontWin_08);
           else begin
