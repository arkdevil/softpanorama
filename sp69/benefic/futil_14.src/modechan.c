...
/* MS-DOS port (c) 1990 by Thorsten Ohl, ohl@gnu.ai.mit.edu
   ...
   $Header: e:/gnu/fileutil/RCS/modechan.c 1.4.0.1 90/09/17 09:27:41 tho Exp $
 */
...
/* Return file mode OLDMODE, adjusted as indicated by the list of change
   operations CHANGES.  If OLDMODE has the S_IFDIR bit set, the type `X'
