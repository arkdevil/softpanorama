 ...
 */
#define RCSBASE "$Id: rcsbase.h%v 1.2 1991/08/23 14:40:08 SGP Exp $"
...
/* $Log: rcsbase.h%v $
# Revision 1.2  1991/08/23  14:40:08  SGP
# Changes made to port to MSDOS environment
#
