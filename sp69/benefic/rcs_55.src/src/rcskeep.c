...
/* $Log: rcskeep.c%v $
 * Revision 1.2  1991/08/23  13:35:13  SGP
...
libId(keepId, "$Id: rcskeep.c%v 1.2 1991/08/23 13:35:13 SGP Exp $")
 ...
 */
{
    ...
    *prevdate = 0;
	...
	static int
getval(register FILE *fp, struct buf *target, int optional)
 ...
 */
{
	...
	static int
get0val(register int c, register FILE *fp, struct buf *target, int optional)
 ...
 */
{
	...
	static int
getprevid(int c, FILE *fp, struct buf *b)
...
/* Get previous revision from FP into prevrev.  */
{
	...
	static int
checknum(register const char *sp,int fields)
