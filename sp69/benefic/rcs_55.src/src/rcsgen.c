...
/* $Log: rcsgen.c%v $
 * Revision 1.2  1991/08/23  13:34:38  SGP
...
libId(genId, "$Id: rcsgen.c%v 1.2 1991/08/23 13:34:38 SGP Exp $")
...
static void scandeltatext P((struct hshentry*,enum stringwork));
	...
	const char *
buildrevision(const struct hshentries *deltas,
 ...
 */
{
	...
	static void
scandeltatext(struct hshentry * delta, enum stringwork func)
...
#endif
{
	...
	void
putdesc(int textflag, const char *textfile)
