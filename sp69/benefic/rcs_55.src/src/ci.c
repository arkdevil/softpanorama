...
/* $Log: ci.c%v $
 * Revision 1.2  1991/08/20  07:11:48  SGP
...
mainProg(ciId, "ci", "$Id: ci.c%v 1.2 1991/08/20 07:11:48 SGP Exp $")
{
 ...
 */
{
	...
	static int
addbranch(struct hshentry *branchpoint,struct buf *num)
 ...
 */
{
	...
	static void
incnum(const char *onum,struct buf *nnum)
...
/* Return a pointer to the current date.  */
{
	...
	static const char *
xpandfile (const char *unexfname,
		   const char *dir,
 ...
 */
{
	...
	static int
mustcheckin (const char *unexfname,const struct hshentry *delta)
