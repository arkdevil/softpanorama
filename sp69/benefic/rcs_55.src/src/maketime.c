 ...
 */
/* $Log: maketime.c%v $
 * Revision 1.2  1991/08/23  13:31:02  SGP
...
libId(maketId, "$Id: maketime.c%v 1.2 1991/08/23 13:31:02 SGP Exp $")
...
static const int daytb[] = {
	...
	static time_t
maketime(const struct tm *atm,int zone)
{
...
time2date(time_t unixtime,char date[datesize])
{
	...
	void
str2date(const char *source, char target[datesize])
