...
/* $Log: rlog.c%v $
 * Revision 1.2  1991/08/23  13:38:56  SGP
...
mainProg(rlogId, "rlog", "$Id: rlog.c%v 1.2 1991/08/23 13:38:56 SGP Exp $")
{
...

{
	...
	static void
putree(const struct hshentry *root)
...

{
	...
	static void
putforest(const struct branchhead *branchroot)
/*   function:  print branches that has the same direct ancestor    */
{
	...
	static void
putabranch(const struct hshentry *root)
...

{
	...
	static void
putadelta(register const struct hshentry *node,
		  register const struct hshentry *editscript,
		  int trunk)
...

{
	...
	static void
recentdate(const struct hshentry *root, struct Datepairs *pd)
...

{
	...
	static char
extractdelta(const struct hshentry *pdelta)
...

{
	...
	static int
checkrevpair(const char *num1,const char *num2)
