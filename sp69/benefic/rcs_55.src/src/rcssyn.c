...
/* $Log: rcssyn.c%v $
 * Revision 1.2  1991/08/23  13:37:43  SGP
...
libId(synId, "$Id: rcssyn.c%v 1.2 1991/08/23 13:37:43 SGP Exp $")
 ...
 */
{
	...
	static const char *
getkeyval(const char *keyword, enum tokens token, int optional)
 ...
 */
{
	...
	static void
putdelta(register const struct hshentry *node,register FILE *fout)
 ...
 */
{
	...
	void
puttree(const struct hshentry *root,register FILE *fout)
