...
/* $Log: rcsrev.c%v $
 * Revision 1.2  1991/08/23  13:37:21  SGP
...
libId(revId, "$Id: rcsrev.c%v 1.2 1991/08/23 13:37:21 SGP Exp $")
 ...
 */
{
	...
	void
getbranchno(const char *revno,struct buf *branchno)
...
int cmpnum(const char *num1, const char *num2)
...
int cmpnumfld(const char *num1, const char *num2, unsigned fld)
