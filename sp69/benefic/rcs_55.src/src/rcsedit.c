...
/* $Log: rcsedit.c%v $
 * Revision 1.2  1991/08/23  13:33:11  SGP
...
libId(editId, "$Id: rcsedit.c%v 1.2 1991/08/23 13:33:11 SGP Exp $")
 ...
 */
{
	...
	void
finishedit(const struct hshentry *delta)
...
editLineNumberOverflow()
{
	...
	static void
copylines(register unsigned long upto,const struct hshentry *delta)
 ...
 */
{
	...
	void
xpandstring(const struct hshentry *delta)
...
{	register c;
	...
	void
editstring(const struct hshentry *delta)
...
const char ciklog[ciklogsize] = "checked in with -k by ";
	...
	static void
keyreplace(enum markers marker,
		   const struct hshentry *delta,
		   register FILE *out)
