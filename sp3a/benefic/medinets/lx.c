...
#define MAXR 16                         /* matrix rows */
#define MAXC 23                         /* matrix columns */
#define H1   3                          /* 1st down-loaded code position */
#define H2   4                          /* 2nd ditto                     */
#define HSZ  5                          /* header size */
#define PSZ  47                         /* character info block size */
...

{
  ...
  if (argc < 2) {
    fprintf(stderr, "LX expected a file name at least.\n");
    exit(1);
  }
  if (argc > 2) {
    fprintf(stderr, "LX didn't expect so many parameters.\n");
    exit(2);
  }
  if ((fd = fopen(*++argv, "r+b")) == NULL) {
    fprintf(stderr, "LX couldn't find the file \"%s\".\n", *argv);
...

{
  ...
  printf("\033[05;10H    1 2 3 4 5 6 7 8 9 A B C D E F G H I J K L M N");
  printf("\033[06;10H  ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐  ");
  printf("\033[07;10H  │   │   │   │   │   │   │   │   │   │   │   │   │ 7");
  printf("\033[08;10H  ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤  7");
  printf("\033[09;10H  │   │   │   │   │   │   │   │   │   │   │   │   │ 6");
