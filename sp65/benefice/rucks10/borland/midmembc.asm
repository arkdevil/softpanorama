...
;  -or-                                                                 |
;        C>tlib RUCKMIDI -midimem +midmembc                             |
...
mid$mallocXit:  ret                     ;that RUCKMIDI will use

mid$mallocEx:   mov     ax,8
                stc
                jmp     SHORT mid$mallocXit
...
;     uses:      ax (return)                                            |
;    notes:      see mid$malloc above for more info                     |
;06-Mar-93-chh                                                          |
;-Added save of dword slot (di) before call to _free                    |
;-Added DS reload                                                       |
;-----------------------------------------------------------------------|
mid$free        PROC USES bx cx dx si di ds es
                ...
                repne scasw
                jne     mid$freeEx      ;not found, must be invalid block
