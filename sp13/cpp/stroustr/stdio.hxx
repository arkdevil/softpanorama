 ...
 *
 * Modified for C++ by MJO'R	10-September-1986
 *
 */
...
/* NULL must be plain 0 for C++ : MJO'R 10Sep86 */
#if ( defined(c_plusplus) || (!defined(M_I86CM) && !defined(M_I86LM)))
#define  NULL    0
#else
#define  NULL    0L
#endif
...
#ifndef	c_plusplus	/* MJO'R 10Sep86 : include const for C++ */
