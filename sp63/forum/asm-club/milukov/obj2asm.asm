...
OutBuffer       db 1024 dup (0) ; кэш
CMD_line        db 128 dup (0)  ; буфеp командной стpоки
Pointers        dw 8 dup (0)    ; указатели на имена
ObjBuf          db 0
.CODE
 ORG 100h
...
CountPGF proc near
        mov     ax,cs
        mov     ObjSeg,ax
        mov     ax,Lo_len               ; длина .obj
        add     ax,offset ObjBuf        ; и где он начался
        shr     ax,1
        shr     ax,1
        shr     ax,1
        shr     ax,1
