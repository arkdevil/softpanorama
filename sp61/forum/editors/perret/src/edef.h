...
NOSHARE extern short kbdm[DUMMYSZ];     /* Holds kayboard macro data	*/
...
NOSHARE extern unsigned char wordlist[DUMMYSZ];
...
NOSHARE extern char DNEAR lasttime[DUMMYSZ];
					/* last time string displayed	*/
...
NOSHARE extern CONST char *cname[DUMMYSZ];
					/* names of colors		*/
...
NOSHARE extern char pat[DUMMYSZ];	/* Search pattern		*/
NOSHARE extern char tap[DUMMYSZ];	/* Reversed pattern array.	*/
NOSHARE extern char rpat[DUMMYSZ];	/* replacement pattern		*/
