...
#if     WINDOW_MSWIN
extern PASCAL cutregion (int f, int n);
extern PASCAL clipregion (int f, int n);
extern PASCAL insertclip (int f, int n);
extern PASCAL helpengine (int f, int n);
extern PASCAL minimizescreen (int f, int n);
extern PASCAL maximizescreen (int f, int n);
extern PASCAL restorescreen (int f, int n);
extern PASCAL tilescreens (int f, int n);
extern PASCAL cascadescreens (int f, int n);
extern PASCAL renamescreen (int f, int n);
extern PASCAL bindtomenu (int f, int n);
extern PASCAL macrotomenu (int f, int n);
extern PASCAL unbindmenu (int f, int n);
extern PASCAL execmenu (int f, int n);
extern PASCAL longop (int f);
extern PASCAL filenamedlg (char *prompt, char *buf, int nbuf, int fullpath);
extern char * PASCAL fullpathname (char *PathName, int Nbuf);
extern PASCAL NEAR vtscreen (SCREEN *sp);
extern int PASCAL NEAR vtinitscr (SCREEN *sp, int nrow, int ncol);
extern PASCAL NEAR vtfreescr (SCREEN *sp);
extern int PASCAL NEAR vtsizescr (SCREEN *sp, int nrow, int ncol);
extern PASCAL NEAR unlist_screen(SCREEN *sp);
extern PASCAL mlabort(char *s);
extern PASCAL mlhistory(void);
extern PASCAL updscrollbars (SCREEN *sp, char w_flag);
#endif
...
extern PASCAL NEAR unlist_screen();
