page ,132
title bluwht ( blue bak - white crsr, brdr ) 01/17/96 - 11:25 pm
;
...
sbc:
         ...
         mov   al,3                    ; toggle blink/intensity bit
         mov   bl,0                    ; set for intensity
         int   16
;
         mov   ah,16                   ; set color fct
         mov   al,1                    ; border color
         mov   bh,15                   ; wht border
         int   16
;*------------------------
;*  set cursor position
;*------------------------
...
wcaa:
         ...
         mov   bh,0                    ; page 0
         mov   bl,31       ; x'1f'     ; attr = blue back, wht crsr
