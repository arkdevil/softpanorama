...
HELP:
call gotoxy 40, 5; SAY '   ________________________________ '
call gotoxy 40, 6; SAY ' /|_Help_Window____________________|'
call gotoxy 40, 7; SAY ' || 1. To move the number,         |'
call gotoxy 40, 8; SAY ' ||     type the number:           |'
call gotoxy 40, 9; SAY ' ||          eg. 15                |'
call gotoxy 40,10; SAY ' || 2. If you give up ,            |'
call gotoxy 40,11; SAY ' ||     type:                      |'
call gotoxy 40,12; SAY ' ||         give up                |'
call gotoxy 40,13; SAY ' || 3. If screen has disappeared , |'
call gotoxy 40,14; SAY ' ||     type:                      |'
call gotoxy 40,15; SAY ' ||         screen                 |'
call gotoxy 40,16; SAY ' || 4. To exit this puzzle         |'
call gotoxy 40,17; SAY ' ||     type:                      |'
call gotoxy 40,18; SAY ' ||         bye                    |'
call gotoxy 40,19; SAY ' ||________________________________|'
call gotoxy 40,20; SAY ' |/_______________________________/ '
...
DO I = 2 TO 5
   ...
   END
END
call gotoxy 15,7;  say '  _________________'
call gotoxy 15,8;  say ' 'LINE.2
call gotoxy 15,9;  say ' ||---+---+---+---| '
call gotoxy 15,10; say ' 'LINE.3
call gotoxy 15,11; say ' ||---+---+---+---| '
call gotoxy 15,12; say ' 'LINE.4
call gotoxy 15,13; say ' ||---+---+---+---| '
call gotoxy 15,14; say ' 'LINE.5
call gotoxy 15,15; say ' ||_______________| '
call gotoxy 15,16; say ' |/______________/  '
RETURN
