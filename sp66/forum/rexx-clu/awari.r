/*
          ...
          translated to IBM REXX by Bill N. Vlachoudis.
                  Bitnet addr:    cacz0200@grtheun1.earn
                  Internet addr:  vlachoudis@olymp.ccf.auth.gr
                  Fido addr:      2:410/1.6
...
Say Center('~~~~~~~~~~~~~~~~~',79)
Say ; Say Center('by vlachoudis@olymp.ccf.auth.gr',79)
Say ;
