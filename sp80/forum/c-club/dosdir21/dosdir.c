/*
  ...
  DOSDIR V2.1: A Portable DOS/UNIX/VMS Directory Interface
  ...
  e-mail: mathews@nssdca.gsfc.nasa.gov

  Copyright (C) 1994 Jason Mathews.
  Permission is granted to any individual or institution to use, copy,
  redistribute or modify this software so long as it is not sold for
