/*
	...
	RCS - Header:
	$Header: c:/daten/fips/source/main/RCS/fipsspec.h 1.1.1.1 1994/10/13 01:54:29 schaefer Exp schaefer $
...
public:
	...
	fips_harddrive (int number):harddrive (number) { get_geometry(); }  // to write register info to debugfile
