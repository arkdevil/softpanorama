...
void CaseConvertion()
{
  struct InitDialogItem InitItems[]={
    DI_DOUBLEBOX,3,1,62,10,0,0,0,0,(char *)MCvtTitle,
    ...
    DI_CHECKBOX,5,7,0,0,0,0,0,0,(char *)MCvtSkipMixedCase,
    DI_TEXT,5,8,0,0,0,0,DIF_BOXCOLOR|DIF_SEPARATOR,0,"",
  ...
  DialogItems[6].Selected=Opt.SkipMixedCase;
  int ExitCode=Info.Dialog(Info.ModuleNumber,-1,-1,66,12,NULL,DialogItems,
  ...
  if (DialogItems[1].Selected)
    ...
    if (DialogItems[2].Selected)
      ...
      if (DialogItems[3].Selected)
        ...
        Opt.ConvertMode=3;
  Opt.SkipMixedCase=DialogItems[6].Selected;
