...
{
  if (PluginsData[PluginNumber].pOpenArchive)
...
{
  if (PluginsData[PluginNumber].pGetArcItem)
...
{
  if (PluginsData[PluginNumber].pCloseArchive)
...
{
  *FormatName=0;
  if (PluginNumber<PluginsCount && PluginsData[PluginNumber].pGetFormatName)
...
{
  *Dest=0;
  if (PluginNumber<PluginsCount && PluginsData[PluginNumber].pGetDefaultCommands)
