NEUROALT:
        jmp start        ; The ALTERNATIVE set KYRYLYZER for NEURON
...
present:
         ...
         mov ah,4CH
         int 21H
alsopre db 07H,0DH,0AH,"ЭМУЛЯТОР АЛЬТЕРНАТИВНОГО НАБОРА ДЛЯ НЕЙРОН/ИСКРА-1030 УЖЕ ЗАГРУЖЕН",0DH,0AH
        db 07H,0DH,0AH,24H
;
setted  db 07H,0DH,0AH,"NEUROALT:ЭМУЛЯТОР АЛЬТЕРНАТИВНОГО НАБОРА ДЛЯ НЕЙРОН/ИСКРА-1030 ЗАГРУЖЕН",0DH,0AH
        db 0DH,0AH
        db             "Переключение русский/латинский: *------*   г.Кировоград УССР",0DH,0AH
        db             "                                | Caps |     тел. 93-9-28",0DH,0AH
        db             "                                | Lock |                       ",0DH,0AH
        ...
        db             "При активном CAPS LOCK с клавиатуры вводятся АЛЬТЕРНАТИВНЫЕ коды.",0dh,0aH
        db 0DH,0AH
