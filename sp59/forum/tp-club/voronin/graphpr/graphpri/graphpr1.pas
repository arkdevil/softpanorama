...
{│  которые вы делаете на экране с учетом тех операций, которые были     │}
{│  сделаны в предыдущем сеансе работы.                                  │}
{│                                                                       │}
{└───────────────────────────────────────────────────────────────────────┘}
      uses  ish,extended,slaid,expand,foread,crt,graph,poly;
 const k=1;
 var
   ...
   grmode,grdriver,nowr,reg,look,tim,xb,yb:integer;
 ...
 label
   ...
   procedure writ;    { процедура сохранения в файле накопленных операторов }
   label
   10,30;
   begin
  ...
  procedure move;   { движение курсора в восьми направлениях }
label 100,101;
    begin
