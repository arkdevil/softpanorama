      BULLET v1.2 ORDER FORM for Credit Cards.  (Bullet/Win C/C++)
      (Check, cash, or money-orders use !ORDER.FRM)
                                                      Qty     Extended

      BULLET, single-license  . . . . . . . $89.00 x _____ = __________
      Refer to the LICENSE AGREEMENT in CZ
      (under TUTORIAL_INDEX)

      Shipping and handling to all destinations
      for credit card orders is $1.00.
      (Next-Day Air shipment to any
       U.S. destination enter $16.00)  Shipping & handling:  __________

                                                  Subtotal:  __________

             (Texas residents only, add 7.75%)   Sales tax:  __________
    ...
    *** 3.5" HD (1.44) media will be used unless you request otherwise ***
      ...
      Bullet ID#: 11185  (Bullet for Windows - C/C++)
      ...
      Card/No.: _________________________________ ExpDate:____________

      Date: ______________   Sign: ____________________________________
