...
Dess proc far
        ...
        mov     cs:StringOffset,bx ; где стpоковый буфеp
        mov     cs:StringSegment,cx
        mov     cs:OutPos,0
        mov     cs:_Class,0
	call	DecodeOne
        mov     ax,cs:_Adr_
...
_C8_detect proc near
        GetCode
        cmp     al,0C8h
	jne	@@1
        lea     si,Tenter ; enter x,y
        call    Type5
        putc    9
        call    PnextWord
        putc    ','
...
Code6xDetect proc near
        GetCode
        cmp     al,68h
	jne	@@1
        lea     si,Tpush ; push imm16
        call    Type5
        call    PnextWord
        retn
@@1:
