...
**** PKZIP 2.04 - НОВЫЙ ЛИДЕР ПО СКОРОСТИ РАБОТЫ СРЕДИ АРХИВАТОРОВ *****
 ...
 он проигрывает ARJ примерно 15K (arj - 724K, pkzip - 740K)
      Похоже, что PKZIP 1.93a нормально распаковывает архивы созданные 
 новой версией! Видимо, формат остался практически прежним, хотя сам 
 алгоритм стал немного быстрее.
...
********** Киевская секция ACM SIGMOD выходит из подполья **************
 и вместе с аналогичной Московской секцией собирается провести семинар
 ...
 Как правило,  участие в семинаре предполагает  выступление  с  докладом,
...
************** МИКРОСОФТ ОБВИНЕН В НЕЧЕСТНОЙ КОНКУРЕНЦИИ ***************
...
********************* КАК НА ЗАПАДЕ ОТНОСЯТСЯ К ПИРАТАМ **********************
