...
Const
     Max_Boot = 10;          { Общее число Boot-СДЯВов }
     I        : Integer = 0;
     J        : Integer = 0;
     K        : Integer = 0;
     ...
     Vir_Boot      : Array [1..Max_Boot] of DiskVirusType =
                   (
                    ...
                    (
                      Maska   : ($C7,$06,$CD,$D3,$0E); { Generic Boot+++ }
                      Offs    : ($143,$144,$159,$15A,$15B);
                      Name    : 96;
                      VType   : Part
                    )
                   );
...
Begin
 ...
 1,92: begin { Stone standart}
   ...
   95: begin { Generic Boot virus }
        If DiskStatus = HardDisk then
           If (Not ReadSector  ( Drive , 0, 0, 13, 1, Buffer )) OR
              (Not WriteSector ( Drive , 0, 0, 1, 1, Buffer )) then Exit
           else
        else begin
              If (Not ReadSector  ( Drive , 1, 0, 3, 1, Buffer )) OR
