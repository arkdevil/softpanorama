 ...
 *
 * $Log:	cmdtab.c,v $
 * Revision 1.9  93/01/04  02:13:31  ache
 * I decide to put all changes into RCS now
 * 
 * Revision 1.8  92/08/24  02:16:28  ache
...
/*NOXSTR*/
static char rcsid[] = "$Header: cmdtab.c,v 1.9 93/01/04 02:13:31 ache Exp $";
/*YESXSTR*/
...
extern int SortMessages(), version(), setdot();
#ifdef PMCS
extern int projects();
#endif

struct cmd cmdtab[] = {
	"next",         next,           NDMLIST,        0,      0,
	...
	"Lpr",          Lpr,            MSGLIST,        0,      MMNDEL,
	"visual",       visual,         I|MSGLIST,      0,      MMNDEL,
	...
	"forward",      Forward,        R|STRLIST,      0,      0,
	"from",         from,           MSGLIST,        0,      MMNDEL,
	"@from",        Xfrom,          MSGLIST,        0,      MMNDEL,
	"file",         file,           T|RAWLIST,      0,      1,
	"folder",       file,           T|RAWLIST,      0,      1,
	"folders",      folders,        T|M|RAWLIST,    0,      1,
#ifdef PMCS
	"projects",     projects,       T|M|RAWLIST,    0,      1,
#endif
	"?",            help,           M|NOLIST,       0,      0,
	"z",            scroll,         STRLIST,        0,      0,
	...
	"@reply",       Xrespond,       R|I|MSGLIST,    0,      MMNDEL,
	"@respond",     Xrespond,       R|I|MSGLIST,    0,      MMNDEL,
	"edit",         editor,         I|MSGLIST,      0,      MMNDEL,
	...
	"submit",       submit,         R|M|I|STRLIST,  0,      0,
	"sort",         SortMessages,   STRLIST,        0,      0,
	"version",      version,        M|NOLIST,       0,      0,
	"dot",          setdot,         MSGLIST,        0,      MMNDEL,
	NULL,           NULL,
};
