...
#define MAXUSERS  300         /* max number of unique users in PASSWD */
...
/* Ache */
	  master = (strcmpi(token, "postmaster") == 0 ||
				strcmpi(token, "MAILER-DAEMON") == 0);
